...
const CASE_STUDIES: Record<string, CaseStudyData> = {
  'TAOCAT': {
    ...
    description: (
      <>
        <strong className="text-white">TAO Cat</strong> is Bittensor's first self-improving AI Agent — engineered by the Masa team and powered by Bittensor and Virtuals. She's not just a memecoin — she's an evolving, real-time AI built on decentralized infrastructure with a competitive spirit.
      </>
    ),
    services: [
