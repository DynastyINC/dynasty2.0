    ...
    <section className="relative h-screen w-full flex flex-col justify-center items-center overflow-hidden bg-dynasty-black">
      ...
      <div className="relative z-10 text-center px-6 max-w-5xl mx-auto">
        ...
        <p className="text-lg md:text-2xl text-gray-400 max-w-2xl mx-auto font-light leading-relaxed mb-12">
          We are not just capital allocators. We are{' '}
          <span className="text-white font-medium">active builders</span>. Deploying advisory, GTM, and engineering
          resources alongside founders to forge the future.
        </p>
        ...
        <div className="flex flex-col sm:flex-row gap-6 justify-center items-center">
          ...
          <button
            ...
            className="group relative px-8 py-4 bg-white text-black font-display font-bold tracking-widest hover:bg-dynasty-lime transition-colors duration-300"
          >
            VIEW PORTFOLIO
          ...
          {/* Secondary CTA: Pitch your vision → contact section */}
          <button
            onClick={() => document.getElementById('contact')?.scrollIntoView({ behavior: 'smooth' })}
            className="flex items-center gap-2 text-white hover:text-dynasty-lime transition-colors duration-300 font-light tracking-wide uppercase text-sm"
          >
